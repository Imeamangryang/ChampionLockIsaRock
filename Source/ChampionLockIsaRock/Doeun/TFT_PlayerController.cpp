...
ATFT_PlayerController::ATFT_PlayerController()
{
...
void ATFT_PlayerController::SetupInputComponent()
{
    Super::SetupInputComponent();

    if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(InputComponent))
    {
       EnhancedInputComponent->BindAction(IA_Grabbed, ETriggerEvent::Started, this, &ATFT_PlayerController::OnGrabPressed);
       EnhancedInputComponent->BindAction(IA_Grabbed, ETriggerEvent::Completed, this, &ATFT_PlayerController::OnDropReleased);
       EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Completed, this, &ATFT_PlayerController::OnMoveInputReleased);
    	EnhancedInputComponent->BindAction(ZoomAction, ETriggerEvent::Triggered, this, &ATFT_PlayerController::OnZoom);
    }
}

void ATFT_PlayerController::OnZoom(const FInputActionValue& Value)
{
...
void ATFT_PlayerController::OnGrabPressed(const FInputActionValue& Value)
{
    if (bIsHoldingUnit)
    {
       PerformDrop();
...
void ATFT_PlayerController::OnDropReleased(const FInputActionValue& Value)
{
...
void ATFT_PlayerController::PerformDrop()
{
    if (!bIsHoldingUnit || !GrabbedUnit) return;
...
void ATFT_PlayerController::Tick(float DeltaTime)
{
...
void ATFT_PlayerController::OnMoveInputReleased()
{
    FHitResult Hit;
...
void ATFT_PlayerController::SaveInitialLocations()
{
...
void ATFT_PlayerController::ReturnAllUnitsToHome()
{
...
void ATFT_PlayerController::UpdateHighlightPosition(FVector MouseLoc)
{
...
bool ATFT_PlayerController::IsUnitOnBench(AActor* Unit) const
{
